                                            ...
                                            <tr>
                                                ...
                                                <?php if($val->is_approved == 0): ?>
                                                    <?php if($auth->can_approve == 1): ?>
                                                        <td><a href="<?php echo e(asset('gml/approveGmlPending/'.$val->id)); ?>" class="btn btn-success">Procurement Approve</a></td>
                                                    <?php else: ?>
                                                        <td>Wait For Procurement Approve</td>
                                                    <?php endif; ?>
                                                <?php elseif($val->is_approved2 == 0): ?>
                                                    <?php if($auth->can_approve2 == 1): ?>
                                                        <td><a href="<?php echo e(asset('gml/approve2GmlPending/'.$val->id)); ?>" class="btn btn-success">Technical Approve</a></td>
                                                    <?php else: ?>
                                                ...
                                                <?php elseif($val->is_approved3 == 0): ?>
                                                    <?php if($auth->can_approve3 == 1): ?>
                                                        <td><a href="<?php echo e(asset('gml/approve3GmlPending/'.$val->id)); ?>" class="btn btn-success">Project Manger Approve</a></td>
                                                    <?php else: ?>
                                                        <td>Wait For Project Manger Approve</td>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                <td>
                                                    <a href="<?php echo e(asset('gml/addsub/'.$val->id )); ?>" class="btn btn-default btn-rounded btn-condensed btn-sm"  title="edit"><span class="fa fa-pencil"></span></a>
