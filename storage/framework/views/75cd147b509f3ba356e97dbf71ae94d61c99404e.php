                                            ...
                                            <tr  class="subMatItems">
                                                ...
                                                <?php if($val->is_approved == 0): ?>
                                                    <?php if($auth->can_approve): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('users/approveSupplier/'.$val->id)); ?>" class="btn btn-success">Procurement Approval</a>
                                                ...
                                                <?php elseif($val->is_approved2 == 0): ?>
                                                    <?php if($auth->can_approve2): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('users/approve2Supplier/'.$val->id)); ?>" class="btn btn-success">Commercial Approval</a>
                                                            <button onclick="reject_User('<?php echo e($val->id); ?>');" class="btn btn-danger">Reject</button>
                                                        </td>
                                                    <?php else: ?>
