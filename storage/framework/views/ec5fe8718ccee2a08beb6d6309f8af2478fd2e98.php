                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <?php if($auth->can_edit): ?>
                                <a href="<?php echo e(asset('gml/add')); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <br />
                                            <form method="GET" action="<?php echo e(asset('gml/show')); ?>" class="input-group" style="height:35px;">
                                                ...
                                                <table class="table table-bordered table-striped table-actions" id="gmlList" style="border:10px solid whitesmoke">
                                                    ...
                                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="subMatItems">
                                                            ...
                                                            <?php if($auth->can_edit): ?>
                                                            <td>
                                                                <a href="add/<?php echo e($val->id); ?>" class="btn btn-default btn-rounded btn-condensed btn-sm"  title="edit"><span class="fa fa-pencil"></span></a>
                                                    ...
                                                    <?php if(count($data)==""): ?>
                                                        <tr class="text-center">
                                                            <td colspan="3" style="color: dimgray;">Sorry, No General Material List Found !</td>
                                                        </tr>
                                                    <?php endif; ?>
                                                </table>
                                            </div>
