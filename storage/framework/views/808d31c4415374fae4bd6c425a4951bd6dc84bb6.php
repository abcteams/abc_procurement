<?php $__env->startSection('content'); ?>
    <ul class="breadcrumb">
        ...
        <li><a href="<?php echo e(URL::previous()); ?>">Sub Materials </a></li>
        <li class="active">Add Material</li>
    </ul>
    <div class="page-title">
        <h2><?php echo e($main_data->title); ?> </h2><h4 style="padding-top:10px">&nbsp -> Add Sub </h4>
    </div>
            ...
            <div class="col-md-12">
                <div style="padding:10px">
                    <div class="panel panel-default">
                        <form class="form-horizontal" method="POST" action="<?php echo e(url('gml/addsubgml')); ?>">
                            ...
                            <div class="panel-footer">
                                <input type="hidden" value="<?php echo e($main_data->id); ?>" name="gmlId" >
