...
@section('content')
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><a href="{{asset('users/showSubcontractor')}}">Subcontractors</a></li>
    ...
    <div class="page-content-wrap" style="background: #e8e8e8;padding-top: 40px;">
        <form class="form-horizontal" method="POST" action="{{ url('users/addSubcontractorInfo') }}">
            {{ csrf_field() }}
            <div class="row">
                ...
                <div class="row" style="padding:20px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            ...
                            <a href="{{asset('users/showSubcontractor')}}" style="width:120px;padding:10px;margin-right: 10px" class="btn btn-danger pull-right">Cancel</a>
                        </div>
                    </div>
