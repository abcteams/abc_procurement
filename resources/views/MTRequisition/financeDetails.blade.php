            ...
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div class="panel-footer" style="padding: 50px">
                        ...
                        <a href="{{asset('/materialrequisition/financeApprove/'.$data['main'][0]->req_id)}}" class="btn btn-success pull-right"  style="margin-right:10px;">Approve</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal" id="modal_reject" tabindex="-1" role="dialog" aria-labelledby="defModalHead" aria-hidden="true">
        <div class="modal-dialog modal-centered">
            <div class="modal-content">
                <form method="post" action="{{asset('/materialrequisition/financeReject')}}" id="reject-form">
                    {!! csrf_field() !!}
