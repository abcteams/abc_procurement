                                            ...
                                            <tr>
                                                ...
                                                <?php if($val->is_approved == 0): ?>
                                                    <?php if($auth->can_approve == 1): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('scl/approveSclPending/'.$val->id)); ?>" class="btn btn-success">Procurement Approve</a>
                                                            <button class="btn btn-danger" id="deleteUser" onclick="delete_row('<?php echo e($val->id); ?>');">Reject</button>
                                                        </td>
                                                    <?php else: ?>
                                                ...
                                                <?php elseif($val->is_approved2 == 0): ?>
                                                    <?php if($auth->can_approve2 == 1): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('scl/approve2SclPending/'.$val->id)); ?>" class="btn btn-success">Technical Approve</a>
                                                            <button class="btn btn-danger" id="deleteUser" onclick="delete_row('<?php echo e($val->id); ?>');">Reject</button>
                                                        </td>
                                                    <?php else: ?>
                                                ...
                                                <?php elseif($val->is_approved3 == 0): ?>
                                                    <?php if($auth->can_approve3 == 1): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('scl/approve3SclPending/'.$val->id)); ?>" class="btn btn-success">Project Manger Approve</a>
                                                            <button class="btn btn-danger" id="deleteUser" onclick="delete_row('<?php echo e($val->id); ?>');">Reject</button>
                                                        </td>
                                                    <?php else: ?>
