                ...
                <div style="padding:10px">
                    <div class="panel panel-default">
                        <form class="form-horizontal" method="POST" action="<?php echo e(url('scr/addscr')); ?>">
                            ...
                            <input type="hidden" name="workzoneId" value="<?php echo e($workzoneId); ?>" >
                            ...
                            <div class="panel-footer">
                                ...
                                <a href="<?php echo e(asset('scr/show/'.$workzoneId)); ?>" style="width:70px" class="btn btn-danger pull-right" >Cancel</a>
                            </div>
                            </div>
                        </form>
                    </div>
