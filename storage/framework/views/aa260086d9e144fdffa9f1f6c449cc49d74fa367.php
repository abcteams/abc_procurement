                ...
                <form action="#" class="form-horizontal">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <?php if($data['main'][0]->active_status == 1): ?>
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-xs-12">
                                    <a href="#" class="btn btn-danger btn-block btn-rounded" data-toggle="modal" data-target="#modal_change_password"  onclick="reset_password('<?php echo e($data['main'][0]->id); ?>');">Reset password</a>
                                </div>
                            </div>
                            <?php if(Auth::user()->id == $data['main'][0]->id): ?>
                            <?php else: ?>
                                <div class="form-group">
                                    <div class="col-md-12 col-xs-12">
                                        <a href="" class="btn btn-danger btn-block btn-rounded" data-toggle="modal" data-target="#modal_change_password" onclick="delete_user('<?php echo e($data['main'][0]->id); ?>');">Delete User</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-xs-7">
                                    <div class="personalInfo"><?php echo e($data['main'][0]->active_status == 1 ? 'Active' : 'InActive'); ?></div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12 col-xs-5">
