        ...
        <div class="col-md-12">
            <div style="padding:10px">
                <div class="panel panel-default">
                    ...
                    <br />
                    <form class="form-horizontal" method="POST" action="<?php echo e(url('boq/agreementsDitals')); ?>"  enctype="multipart/form-data">
                                        ...
                                        <div class="panel-body ">
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="col-md-8 col-xs-8">
                                                        <div class='input-group'>
                                                            <input type="hidden" value="<?php echo e($data->sub_gml_id); ?>" name="sub_gml_id">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="col-md-8 col-xs-8">
                                                        <div class='input-group'>
                                                            <input type="hidden" name="boq" value="<?php echo e(request('id')); ?>">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-footer">
                            ...
                            <a href="<?php echo e(asset('boq/showsubboq/'.request('id'))); ?>" style=" padding: 10px;width: 100px" class="btn btn-danger pull-right" >Cancel</a>
                            <br/>
                            <br/>
                            <br/>
                            <br/>
