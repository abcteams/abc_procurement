        ...
        <div class="page-content">
            <ul class="x-navigation x-navigation-horizontal x-navigation-panel">
                ...
                <li class="xn-icon-button pull-right">
                    ...
                    <div class="informer informer-danger" id="cart_lenght"><?php echo e(count($cart['materials']) + count($cart['accessories'])); ?></div>
                    <div class="panel panel-primary animated zoomIn xn-drop-left xn-panel-dragging">
                        <div class="panel-heading">
                            <h3 class="panel-title"><span class="fa fa-shopping-cart"></span> Cart</h3>
                            <div class="pull-right">
                                <span class="label label-danger" id="cart_lenght2"><?php echo e(count($cart['materials']) + count($cart['accessories'])); ?></span>
                            </div>
                        </div>
                                    ...
                                    <table id="myCart" class="table-striped">
                                        ...
                                        <?php $__currentLoopData = $cart['materials']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><div onclick="removeCartItem(this,<?php echo e($val->id); ?>)" style="color: red;cursor: pointer">remove</div></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="panel-footer text-center">
                            <a href="<?php echo e(asset('materialrequisition/showCart')); ?>" class="btn btn-success pull-right">View Cart</a>
                            <a href="<?php echo e(asset('materialrequisition/myOrders')); ?>" class="btn btn-info pull-left">My Orders</a>
                        </div>
                    </div>
                </li>
            </ul>
