    ...
    <div class="row">
        <div class="col-md-12">
                <div class="panel panel-default">
                    <form class="form-horizontal" method="POST" action="{{ url('subcontractor/addDecline') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="panel-footer">
                            ...
                            <a href="{{asset('subcontractor/pendingRequest')}}" style="width:70px" class="btn btn-danger pull-right" >Cancel</a>
                        </div>
                    </div>
                </form>
            </div>
