                                        ...
                                        @foreach($data as $k => $val)
                                            <tr  class="subMatItems">
                                                ...
                                                @if($val->is_approved == 0)
                                                    @if($auth->can_approve)
                                                        <td>
                                                            <a href="{{asset('users/approveSubcontractor/'.$val->id)}}" class="btn btn-success">Procurement Approval</a>
                                                ...
                                                @elseif($val->is_approved2 == 0)
                                                    @if($auth->can_approve2)
                                                        <td>
                                                            <a href="{{asset('users/approve2Subcontractor/'.$val->id)}}" class="btn btn-success">Commercial Approval</a>
                                                            <button onclick="reject_User('{{$val->id}}');" class="btn btn-danger">Reject</button>
                                                        </td>
                                                    @else
