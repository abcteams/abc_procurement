                ...
                <form action="#" class="form-horizontal">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-xs-12">
                                    <a href="<?php echo e(asset('users/deleteSubcontractor/'.$data[0]->user_id)); ?>" class="btn btn-danger btn-block btn-rounded">Delete User </a>
                                </div>
                            </div>
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-xs-5">
                                    <div class="col-md-12 col-xs-12">
                                        <div class="personalInfo pull-right"><a href="<?php echo e(asset('subcontractor/addmaterial/'.$data[0]->user_id)); ?>" class="btn btn-info"  style="padding: 10px">Subcontractor Materials</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
