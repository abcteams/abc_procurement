                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr  class="subMatItems">
                                                <td title="Sub Items" onclick="subcontractorInfo('<?php echo e($val->id); ?>')">
                                                    <strong>
                                                        <?php echo e($val->name); ?>

                                                    </strong>
                                                </td>
                                                <td  onclick="subcontractorInfo('<?php echo e($val->id); ?>')">
                                                ...
                                                <?php if($val->is_approved == 0): ?>
                                                    <?php if($auth->can_approve): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('users/approveSubcontractor/'.$val->id)); ?>" class="btn btn-success">Procurement Approval</a>
                                                            <button onclick="reject_User('<?php echo e($val->id); ?>');" class="btn btn-danger">Reject</button>
                                                        </td>
                                                    <?php else: ?>
                                                ...
                                                <?php elseif($val->is_approved2 == 0): ?>
                                                    <?php if($auth->can_approve2): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('users/approve2Subcontractor/'.$val->id)); ?>" class="btn btn-success">Commercial Approval</a>
                                                            <button onclick="reject_User('<?php echo e($val->id); ?>');" class="btn btn-danger">Reject</button>
                                                        </td>
                                                    <?php else: ?>
                                        ...
                                        <?php if(count($data)==""): ?>
                                            <tr class="text-center">
                                                <td colspan="6" style="color: dimgray;">No Pending Subcontractors !</td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
