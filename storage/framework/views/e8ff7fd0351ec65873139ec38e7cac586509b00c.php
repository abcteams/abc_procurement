                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group"  style="width: 100%">
                                                    <select id="quantity_unit"  name="quantity_unit" class="select2 form-control">
                                                        ...
                                                        <option value="No's" <?php echo e($q_unit == "piece"?'selected':''); ?>>No's</option>
                                                        ...
                                                        <option value="Kg" <?php echo e($q_unit == "Box"?'selected':''); ?>>Kg</option>
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-5">
                                                <div class="input-group" style="width: 100%">
                                                    <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                    <input id="unitPrice" name="unitPrice" type="number" value="<?php echo e(old('unitPrice')); ?>" step="0.01" class="form-control" onchange="getTotalPrice()" required>
                                                </div>
                                            </div>
