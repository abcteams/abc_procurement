                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                <div class="text-right">
                                    <form action="<?php echo e(asset('notification/markAllAsRead')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="subMatItems">
                                                    <td onclick="gotoLink('<?php echo e($val->link); ?>')" style="<?php echo e($val->is_read ==0 ? 'background:#fff2e1;':''); ?>"><span class="fa fa-clock-o" style="padding-right:10px;">
                                                        </span><?php echo e(\Carbon\Carbon::parse($val->created_at,'Asia/Dubai')->diffForHumans()); ?>

                                                    </td>
                                                    <td onclick="gotoLink('<?php echo e($val->link); ?>')" style="<?php echo e($val->is_read ==0 ? 'background:#fff2e1;':''); ?>"><?php echo e($val->description); ?></td>
                                                    <input type="hidden" id="notification_id" value="<?php echo e($val->id); ?>">
                                                </tr>
