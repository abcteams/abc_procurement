                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group" style="width: 100%">
                                                    <input id="quantity" type="number" value="<?php echo e(isset($theRecord[0])?$theRecord[0]->quantity:''); ?>" class="form-control" name="quantity" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group" style="width: 100%">
                                                    <input id="budgetory" type="number" step="0.01" value="<?php echo e(isset($theRecord[0])?$theRecord[0]->budgetory_price:''); ?>" class="form-control" name="budgetory" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group" style="width: 100%">
                                                    <input type="text" id="description" class="form-control" name="description"  value="<?php echo e(isset($theRecord[0])?$theRecord[0]->description:''); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group" style="width: 100%">
                                                    <textarea id="description" class="form-control" name="work_scope" ><?php echo e(isset($theRecord[0])?$theRecord[0]->work_scope:''); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
