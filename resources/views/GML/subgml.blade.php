...
@section('content')
    ...
    <div class="page-title">
        <h2>{{$main_data->title}} </h2><h4 style="padding-top:10px">&nbsp <i class="fa fa-arrow-right" style="font-size: 15px;"></i> Sub Materials List</h4>
    </div>
                ...
                <div style="padding:10px">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            @if($auth->can_edit)
                                <a href="{{asset('gml/addsub/'.$main_data->id )}}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <br />
                                            <form method="GET" action="{{asset('gml/showsub/'.request('id'))}}" class="input-group" style="height:35px;">
                                                ...
                                                <table class="table table-bordered table-striped table-actions" id="subGmlList" style="border:10px solid whitesmoke">
                                                    ...
                                                    @foreach($data as $k => $val)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <a href="{{asset('gml/addsub/'.$main_data->id.'/'.$val->id )}}" class="btn btn-default btn-rounded btn-condensed btn-sm"  title="edit"><span class="fa fa-pencil"></span></a>
