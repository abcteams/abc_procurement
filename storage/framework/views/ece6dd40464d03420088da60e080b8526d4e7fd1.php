                                    ...
                                    <table class="table table-bordered table-striped table-actions">
                                        ...
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo e(asset('materialrequisition/deliveredDetails/'.$val->req_id)); ?>" class="btn btn-info">Details</a></td>
                                                <td><a href="<?php echo e(asset('materialrequisition/markaspaid/'.$val->req_id)); ?>" class="btn btn-success">Mark As Paid</a></td>
                                            </tr>
