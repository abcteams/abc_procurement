                        ...
                        <div class="panel-body form-group-separated">
                            <div class="form-group">
                                <div class="col-md-12 col-xs-12">
                                    <a href="<?php echo e(asset('users/ccEmails/'.$data['main'][0]->id)); ?>" class="btn btn-success btn-block btn-rounded" data-toggle="modal">CC Emails</a>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-md-12 col-xs-12">
                                    <a href="<?php echo e(asset('users/updateMyPassword')); ?>" class="btn btn-danger btn-block btn-rounded" data-toggle="modal">Chenge Password</a>
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body form-group-separated">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-xs-7">
                                    <div class="personalInfo"> <?php echo e(isset($data['genral'][0]->age)?$data['genral'][0]->age:''); ?> Years</div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-xs-5">
                                    <a href="<?php echo e(asset('users/editMyInfo')); ?>" class="btn btn-danger btn-rounded pull-right">Edit</a>
                                </div>
                            </div>
                        </div>
                    </div>
