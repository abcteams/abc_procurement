<?php $__env->startSection('content'); ?>
    ...
    <div class="page-content-wrap" style="background: #e8e8e8;padding-top: 40px;">
        <form class="form-horizontal" method="POST" action="<?php echo e(url('users/updateMyInfo')); ?>">
                                    ...
                                    <div class="col-md-9 col-xs-7">
                                        <div class='input-group'>
                                            <select class="form-control"  name="gender" required>
                                                ...
                                                <option value="male" <?php echo e(isset($data['genral'][0])?$data['genral'][0]->gender == 'male'?'selected':'':''); ?>>Male</option>
                                                <option value="female" <?php echo e(isset($data['genral'][0])?$data['genral'][0]->gender == 'female'?'selected':'':''); ?>>Female</option>
                                            </select>
            ...
            <div class="row" style="padding:20px">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        ...
                        <a href="<?php echo e(URL::previous()); ?>" style="width:120px;padding:10px;margin-right: 10px" class="btn btn-danger pull-right">Cancel</a>
                    </div>
                </div>
