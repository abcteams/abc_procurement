                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch switch-small">
                                                    <label class="switch switch-small">
                                                        <input type="checkbox"  id="can_approve<?php echo e(intval($data[2]->screen)); ?>"  <?php echo e(intval($data[2]->can_approve) == 1 ? 'checked':''); ?>    >
                                                        <span></span>
                                                    </label>
                                                </label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch switch-small">
                                                    <label class="switch switch-small">
                                                        <input type="checkbox"  id="can_approve2<?php echo e(intval($data[2]->screen)); ?>"  <?php echo e(intval($data[2]->can_approve2) == 1 ? 'checked':''); ?>    >
                                                        <span></span>
                                                    </label>
                                                </label>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch switch-small">
                                                    <label class="switch switch-small">
                                                        <input type="checkbox"  id="can_approve3<?php echo e(intval($data[2]->screen)); ?>"  <?php echo e(intval($data[2]->can_approve3) == 1 ? 'checked':''); ?>    >
                                                        <span></span>
                                                    </label>
                                                </label>
                                            </td>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch switch-small">
                                                    <label class="switch switch-small">
                                                        <input type="checkbox" id="can_edit<?php echo e(intval($data[7]->screen)); ?>"<?php echo e(intval($data[7]->can_edit) == 1 ? 'checked':''); ?>   >
                                                        <span></span>
                                                    </label>
                                                </label>
                                            </td>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <label class="switch switch-small">
                                                    <label class="switch switch-small">
                                                        <input type="checkbox" id="can_edit<?php echo e(intval($data[6]->screen)); ?>"<?php echo e(intval($data[6]->can_edit) == 1 ? 'checked':''); ?>   >
                                                        <span></span>
                                                    </label>
                                                </label>
                                            </td>
