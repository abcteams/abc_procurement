<?php $__env->startSection('content'); ?>
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li><a href="<?php echo e(asset('users/showSuppliers')); ?>">Suppliers</a></li>
            ...
            <div class="row" style="padding:20px">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        ...
                        <a href="<?php echo e(asset('users/showSuppliers')); ?>" style="width:120px;padding:10px;margin-right: 10px" class="btn btn-danger pull-right">Cancel</a>
                    </div>
                </div>
