                                            ...
                                            <tr>
                                                ...
                                                <?php if($val->is_approved == 0): ?>
                                                    <?php if($auth->can_approve == 1): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('gml/approveGmlPending/'.$val->id)); ?>" class="btn btn-success">Procurement Approval</a>
                                                ...
                                                <?php elseif($val->is_approved2 == 0): ?>
                                                    <?php if($auth->can_approve2 == 1): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('gml/approve2GmlPending/'.$val->id)); ?>" class="btn btn-success">Technical Approval</a>
                                                            <button class="btn btn-danger" id="deleteUser" onclick="showDeleteModel(<?php echo e($val->id); ?>)">Technical Reject</button>
                                                        </td>
                                                    <?php else: ?>
                                                ...
                                                <?php elseif($val->is_approved3 == 0): ?>
                                                    <?php if($auth->can_approve3 == 1): ?>
                                                        <td>
                                                            <a href="<?php echo e(asset('gml/approve3GmlPending/'.$val->id)); ?>" class="btn btn-success">Project Manger Approval</a>
