...
<?php $__env->startSection('content'); ?>
    <ul class="breadcrumb">
        <li><a href="#">Home</a></li>
        <li class="active"><a href="<?php echo e(asset('users/showSubcontractor')); ?>">Subcontractors</a></li>
    ...
    <div class="page-content-wrap" style="background: #e8e8e8;padding-top: 40px;">
        <form class="form-horizontal" method="POST" action="<?php echo e(url('users/addSubcontractorInfo')); ?>">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body form-group-separated">
                                ...
                                <div class="form-group" >
                                    ...
                                    <div class="col-md-9 col-xs-7">
                                        <div class='input-group'>
                                            <input id="phone_number" type="number" value="<?php echo e(isset($data['genral'][0])?$data['genral'][0]->phone_number:old('phone_number')); ?>" class="form-control" name="phone_number" required>
                ...
                <div class="row" style="padding:20px">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-4 col-xs-4">
                            ...
                            <a href="<?php echo e(asset('users/showSubcontractor')); ?>" style="width:120px;padding:10px;margin-right: 10px" class="btn btn-danger pull-right">Cancel</a>
                        </div>
                    </div>
