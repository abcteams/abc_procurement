        ...
        <div class="row">
            <div class="col-md-12">
                <div style="padding:10px">
                    ...
                    <div class="panel panel-default">
                        <form class="form-horizontal" method="POST" action="<?php echo e(url('materialinquiry/addDeclineReplay')); ?>"  enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group"  style="width: 100%">
                                                    <textarea class="form-control" id="body" rows="7" name="description"><?php echo e(old('body')); ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
