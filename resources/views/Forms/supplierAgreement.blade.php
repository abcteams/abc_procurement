...
<div class="page-container" style="height: 1000px;">
    <div class="page-sidebar" style="padding: 1px;float: left;">
        ...
        <div style="padding: 15px;border-left: 2px solid #faee05;margin: 10px;text-align: center">
            ...
            <span  style="color:#faee05;font-size: 20px;font-family: Andalus">{{strtoupper($data->workzone)}}</span>
        </div>
        <div style="padding: 15px;border-left: 2px solid #faee05;margin: 10px;;text-align: center">
                ...
                <div class="row">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body" style="padding: 30px">
                            ...
                            <h5>This to confirm ABC Acceptance for your Quotation Ref ( {{$data->quotation_ref}} ) .</h5><br/>
                            <p><h3 style=" text-decoration: underline;">Terms and Conditions : </h3></p>
                            <h5 style="padding:20px ">
                                1- &nbsp;&nbsp;Payment trems : &nbsp;{{$data->payment_terms}} .<br/><br/>
                                2- &nbsp;&nbsp;Supplier To Provied material submittal {{$data->submital_requisted}} ( {{$data->copies_number}} Copies ) within 2 days .<br/><br/>
                                3- &nbsp;&nbsp;This Agreement is Subject to consultant Approval .<br/><br/>
                            </h5>
                        </div>
                        <div class="panel-footer">
                            <a href="{{asset('forms/acceptAgreement/'.$data->id.'/'.$data->work_zone_id.'/'.$data->sub_gml_id)}}" style="margin-left:10px;padding: 10px;width: 100px"class="btn btn-success pull-right" >Accept</a>
                            ...
                            <div class="row" style="display:none;" id="agreementDecline">
                                <form class="form-horizontal" method="POST" action="{{ url('forms/agreementDecline') }}">
                                    {{ csrf_field() }}
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" value="{{$data->id}}" name="agreement_id">
                                    </div>
                                </div>
