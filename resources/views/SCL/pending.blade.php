                                            ...
                                            <tr>
                                                ...
                                                @if($val->is_approved == 0)
                                                    @if($auth->can_approve == 1)
                                                        <td>
                                                            <a href="{{asset('scl/approveSubPending/'.$val->id)}}" class="btn btn-success">Procurement Approve</a>
                                                            <button class="btn btn-danger" id="deleteUser"  onclick="delete_sub('{{$val->id}}' , 2);">Reject</button>
                                                        </td>
                                                        </td>
                                                    @else
                                                ...
                                                @elseif($val->is_approved2 == 0)
                                                    @if($auth->can_approve2 == 1)
                                                        <td>
                                                            <a href="{{asset('scl/approve2SubPending/'.$val->id)}}" class="btn btn-success">Technical Approve</a>
                                                            <button class="btn btn-danger" id="deleteUser"  onclick="delete_sub('{{$val->id}}' , 2);">Reject</button>
                                                        </td>
                                                    @else
                                                ...
                                                @elseif($val->is_approved3 == 0)
                                                    @if($auth->can_approve3 == 1)
                                                        <td>
                                                            <a href="{{asset('scl/approve3SubPending/'.$val->id)}}" class="btn btn-success">Project Manger Approve</a>
                                                            <button class="btn btn-danger" id="deleteUser"  onclick="delete_sub('{{$val->id}}' , 2);">Reject</button>
                                                        </td>
                                                    @else
